...
const Terms = () => {
  return (
    <>
      <Popover className="lg:hidden left-0 fixed">
        {({ open }) => (
          <>
            <Popover.Button>
              <div className="fixed top-20 rounded-r-xl bg-greeny">
                <a className="cursor-pointer">
                  <HiInformationCircle className="w-5 h-5 text-gray-50 " />
                </a>
              </div>
            </Popover.Button>
      ...
      <div className="flex">
        ...
        <div
          className="lg:mx-auto lg:w-2/3  overflow-y-scroll mx-8 h-[60vh]"
          id="privacy"
        >
          <div className="text-center md:text-left flex flex-col text-gray-700">
          ...
          <div className=" text-lg text-darkGreeny">
            <ul>
              <li>
                <div className="py-4">
                  This website is operated by WebWorks Dreams. Throughout the
                  site, the terms “we”, “us” and “our” refer to WebWorks Dreams.
                  WebWorks Dreams offers this website, including all
          ...
          <div id="personal-data" className="text-lg text-darkGreeny">
            {/* SECTION 1 */}
            <ul>
              <li className="py-4 font-bold">SECTION 1 - ONLINE STORE TERMS</li>
            </ul>
            <div>
              <ul>
            ...
            {/* SECTION 2 */}
            <ul>
              <li className="py-4 font-bold">SECTION 2 - GENERAL CONDITIONS</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 7 */}
            <ul>
              <li className="py-4 font-bold">SECTION 7 - OPTIONAL TOOLS</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 8 */}
            <ul>
              <li className="py-4 font-bold">SECTION 8 - THIRD-PARTY LINKS</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 12 */}
            <ul>
              <li className="py-4 font-bold">SECTION 12 - PROHIBITED USES</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            <div>
              <ul>
                ...
                <li className="py-1 ml-10">
                  In no case shall WebWorks Dreams, our directors, officers,
            ...
            {/* SECTION 14 */}
            <ul>
              <li className="py-4 font-bold">SECTION 14 - INDEMNIFICATION</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
                  You agree to indemnify, defend and hold harmless WebWorks
                  Dreams and our parent, subsidiaries, affiliates, partners,
            ...
            {/* SECTION 15 */}
            <ul>
              <li className="py-4 font-bold">SECTION 15 - SEVERABILITY</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 16 */}
            <ul>
              <li className="py-4 font-bold">SECTION 16 - TERMINATION</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 17 */}
            <ul>
              <li className="py-4 font-bold">SECTION 17 - ENTIRE AGREEMENT</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
            ...
            {/* SECTION 18 */}
            <ul>
              <li className="py-4 font-bold">SECTION 18 - GOVERNING LAW</li>
            </ul>
            <div>
              <ul>
                <li className="py-1 ml-10">
