...
export const pricing = () => {
  ...
  return (
    <div>
      <main>
        <div className="flex justify-center bg-gradient-to-b from-blue-100 px-2 sm:px-5 md:px-10">
          <div className="container md:text-center block md:flex justify-between my-8 mt-36 xl:px-40">
            <div className="w-full inline-flex justify-center">
              <div className="text-center w-full">
                <p className="sm:text-2xl md:text-3xl lg:text-4xl text-regal-blue">
                  Pricing
                </p>
                <p className="pb-4 text-4xl sm:text-5xl md:text-6xl lg:text-6xl text-regal-blue font-bold">
                  Purchasing made easy
                </p>
                <p className="sm:text-2xl md:text-3xl lg:text-3xl text-regal-blue mb-12">
                  Our pricing plans have been designed to meet your needs.
                </p>
                <section className="text-left">
                  <table className="table-auto border-blue-400">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-regal-blue text-xs sm:text-lg">
                          <div className="flex-col">
                            <div className="md:py-5 text-sm sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-bold">
                              {headerInfo.price.price1}
                            </div>
                            <div className="text-blue-500 pr-5 py-5 text-xs sm:text-sm md:text-md lg:text-md">
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="./package/starter">
                            <button
                              type="submit"
                              className="text-xs sm:text-sm md:text-xl bg-regal-blue text-white hover:bg-blue-500 rounded-md py-1 mb-5 w-3/4"
                            >
                              Starter
                            </button>
                          </form>
        ...
        <div className="flex flex-col lg:flex-row lg:flex lg:text-left w-full mt-12 xl:px-40">
            ...
            <div className="md:text-left flex justify-center my-auto">
              <div className="w-full">
                <div className="container mx-auto flex justify-center md:my-32 my-12">
                  <div className="text-regal-blue px-5 text-base md:text-4xl lg:text-3xl xl:text-4xl">
